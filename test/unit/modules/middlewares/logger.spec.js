...
const LoggerMiddleware = require(path.join(srcDir, '/modules/middlewares/logger'))('api-test');
...
describe('Middleware: Logger', () => {
  ...
  it('run', async () => {
    ...
    expect(loginfo.args[0][1]).to.deep.eq(Object.assign({ service: 'api-test:logger' }, ctx.requestInfo));
  });
